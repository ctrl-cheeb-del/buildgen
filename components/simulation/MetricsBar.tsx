...
export default function MetricsBar() {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 pointer-events-auto">
      <div className="flex items-center gap-0.5 px-2 py-1 rounded-full bg-white/15 backdrop-blur-2xl border border-white/25 shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_4px_16px_rgba(0,0,0,0.2)]">
